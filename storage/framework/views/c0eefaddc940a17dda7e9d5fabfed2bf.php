...
<body>
    ...
    <div class="container text-center my-5 p-5">
        <form method="post" action="<?php echo e(route('post-news-submit')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row g-3">
...
<?php /**PATH /home/zobaidul/example-app/resources/views/PostNewsSubmit.blade.php ENDPATH**/ ?>